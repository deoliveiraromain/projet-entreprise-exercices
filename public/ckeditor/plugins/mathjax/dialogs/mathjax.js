...
CKEDITOR.dialog.add("mathjax", function (d) {
    ...
    return{title: b.title, minWidth: 350, minHeight: 100, contents: [
        {id: "info", elements: [
            ...
            {id: "documentation", type: "html", html: '<div style="width:100%;text-align:right;margin:-8px 0 10px"><a class="cke_mathjax_doc" href="' + b.docUrl + '" target="_black" style="cursor:pointer;color:#00B2CE;text-decoration:underline">' + b.docLabel + "</a></div>"},
