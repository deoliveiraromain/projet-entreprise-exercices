...
// Put parent styles before child styles.
    ...
    CKEDITOR.addCss( 'ol.exo-question-format { list-style-type:lower-alpha; font-weight:bold } ' );
    CKEDITOR.addCss( 'ol.exo-question-format ol { list-style-type:lower-roman; font-style:italic; font-weight:normal } ' );
    CKEDITOR.addCss( 'ol.exo-sous-question-format { list-style-type: lower-roman; font-style:italic} ' );
...
// Make fresh selection.
    ...
    CKEDITOR.plugins.add( 'list', {
        ...
        icons: 'bulletedlist,bulletedlist-rtl,numberedlist,numberedlist-rtl,questionlist,subquestionlist', // %REMOVE_LINE_CORE%
...
// Register commands.
            ...
            editor.addCommand( 'questionlist', new listCommand( 'questionlist', 'ol', 'exo-question-format' ) );
            editor.addCommand( 'subquestionlist', new listCommand( 'subquestionlist', 'ol', 'exo-sous-question-format' ) );
...
// Register the toolbar button.
            if ( editor.ui.addButton ) {
                ...
                editor.ui.addButton( 'QuestionList', {
                    label: editor.lang.list.questionlist,
                    command: 'questionlist',
                    directional: true,
                    toolbar: 'list,30'
                });
                editor.ui.addButton( 'SubQuestionList', {
                    label: editor.lang.list.subquestionlist,
                    command: 'subquestionlist',
                    directional: true,
                    toolbar: 'list,40'
                });
            }
            ...
            editor.dataProcessor.dataFilter.addRules( {
                elements: {
                    ol: function( element ) {
                        ...
                        if ( className && className.match( /exo-question-format/g ) )
                            element.attributes[ 'data-questionlist' ] = true;
                        else if ( className && className.match( /exo-sous-question-format/g ) )
                            element.attributes[ 'data-subquestionlist' ] = true;
                        else
            ...
            editor.dataProcessor.htmlFilter.addRules( {
                elements: {
                    ol: function( element ) {
                        ...
                        delete element.attributes[ 'data-questionlist' ];
                        delete element.attributes[ 'data-subquestionlist' ];
                    },
                    ul: function( element ) {
